...
/**
 * @title Membership
 * @dev Proves ownership of a note in Sunset's state tree
 *
 * SECURITY MODEL:
 ...
 *
 * This is the fundamental building block for all private operations in Sunset.
 ...
 * - SunsetCommitment: ~486 constraints
...
template Membership(levels) {
    ...
    // This must match the Sunset contract-side commitment format exactly
    component commitment = SunsetCommitment();
    ...
    // Zero commitments are rejected by the Sunset verifier flow
...
// Main component with 20 levels for Sunset's state tree
