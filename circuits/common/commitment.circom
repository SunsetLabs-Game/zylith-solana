...
/**
 * @title SunsetCommitment
 * @dev Generates Sunset-specific commitment hashes compatible with the Anchor program state on Solana
 *
 * This template produces the unique nullifier-commitment mapping required
 * by the Sunset Solana programs and Anchor-based verifier flow. The hash structure is:
 *
...
/**
 * @title SunsetPositionCommitment
 ...
 */
template SunsetPositionCommitment() {
    //////////////////////// INPUT SIGNALS ////////////////////////
