...
/**
 * @title PrivateMint
 * @dev Proves valid private liquidity provision to a Sunset CLMM pool
 *
 * SECURITY MODEL:
 ...
 *
 * @param levels Number of levels in the Merkle tree (20 for Sunset)
 */
template PrivateMint(levels) {
    ...
    component inputCommitment0 = SunsetCommitment();
    ...
    component inputCommitment1 = SunsetCommitment();
    ...
    component positionCommit = SunsetPositionCommitment();
    ...
    component changeCommit0 = SunsetCommitment();
    ...
    component changeCommit1 = SunsetCommitment();
...
/**
 * @title PrivateBurn
 * @dev Proves valid private liquidity removal from a Sunset CLMM pool
 *
 * SECURITY MODEL:
 * This circuit proves that:
...
template PrivateBurn(levels) {
    ...
    component outputCommit0 = SunsetCommitment();
    ...
    component outputCommit1 = SunsetCommitment();
