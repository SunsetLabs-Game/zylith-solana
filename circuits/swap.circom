...
/**
 * @title PrivateSwap
 * @dev Proves a valid private swap operation in Sunset CLMM
 *
 * SECURITY MODEL:
...
template PrivateSwap(levels) {
    ...
    component inputCommitment = SunsetCommitment();
    ...
    component outputCommitment = SunsetCommitment();
    ...
    component changeCommit = SunsetCommitment();
