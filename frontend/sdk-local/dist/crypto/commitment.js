...
import { tokenToBigInt2, } from "../utils/conversions.js";
/**
 ...
 */
export function computeCommitment(secret, nullifier, amountLow, amountHigh, token) {
 ...
 */
export function computePositionCommitment(secret, nullifier, tickLower, tickUpper, liquidity) {
